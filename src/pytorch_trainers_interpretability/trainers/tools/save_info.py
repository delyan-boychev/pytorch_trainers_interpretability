...
class SaveInfo:
    ...
    def save_model(self, model_state_dict, epoch, loss, optimizer_state_dict, lr_scheduler_state_dict=None, best=False):
        save = {"model_state_dict": model_state_dict, "epoch": epoch,
                "loss": loss, "optimizer_state_dict": optimizer_state_dict}
    ...
    def save_loss_plot(self):
        ...
        if hasattr(self, "acc_test_adv"):
            plt.plot(iters, self.loss_test_adv, 'g-',
                     label="Test loss adversarial")
    ...
    def save_acc_plot(self):
        ...
        if hasattr(self, "acc_test_adv"):
            plt.plot(iters, self.acc_test_adv, 'g-',
                     label="Test accuracy adversarial")
    ...
    def save_train_info(self):
        info = {"acc_train": self.acc_train, "loss_train": self.loss_train, "acc_test": self.acc_test,
                "loss_test": self.loss_test, "best_test_acc": self.best_test_acc, "best_comp_acc": self.best_comp_acc}
        if hasattr(self, "acc_test_adv"):
